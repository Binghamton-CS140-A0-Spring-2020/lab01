...
//			e.printStackTrace(out);
		...
		try{
			++testNum;
			Class<?> pClass = Class.forName("lab01.Person");
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> pClass = Class.forName("lab01.Person");
			Method m = pClass.getMethod("getLastNames");
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> pClass = Class.forName("lab01.Person");
			Constructor<?> c = pClass.getConstructor(String.class, String.class, Integer.TYPE, Integer.TYPE, Integer.TYPE);
			Object c1 = c.newInstance("Wilson", "Mary Joe", 2005, 3, 20);
			Method m = pClass.getMethod("getLastNames");
			String actual = (String)m.invoke(c1);
...
//			e.printStackTrace(out);
		...
		try{
			...
			Constructor<?> c = pClass.getConstructor(String.class, String.class, Integer.TYPE, Integer.TYPE, Integer.TYPE);
			Object c1 = c.newInstance("Wilson", "Mary Joe", 2005, 3, 20);
			Method m = pClass.getMethod("getFirstNames");
			String actual = (String)m.invoke(c1);
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> pClass = Class.forName("lab01.Person");
			Method m = pClass.getMethod("getDateOfBirth");
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> pClass = Class.forName("lab01.Person");
			Method m = pClass.getMethod("ageInYears");
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			++testNum;
			Class<?> pClass = Class.forName("lab01.Person");
			Class<?> sClass = Class.forName("lab01.Student");
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class<?> sClass = Class.forName("lab01.Student");
			sClass.getConstructor(pClass, String.class, Double.TYPE);
			Method m = sClass.getMethod("getAsPerson");
			Class<?> c2 = m.getReturnType();
			testEquality("" + pClass, "" + c2, testNum + " getAsPerson return type:");
		} catch(Exception e){
			++numWrong;
			out.println("TEST " + testNum + " FAILED: Either Student does not exist");
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> sClass = Class.forName("lab01.Student");
			Method m = sClass.getMethod("getMajor");
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> sClass = Class.forName("lab01.Student");
			Method m = sClass.getMethod("getGpa");
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			...
			Class.forName("lab01.Person");
			Class<?> sClass = Class.forName("lab01.Student");
			Method m = sClass.getMethod("setGpa", Double.TYPE);
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try{
			...
			Method m = sClass.getMethod("setGpa", Double.TYPE);
			m.invoke(s, 3.0);
			Method m1 = sClass.getMethod("getGpa");
...
//			e.printStackTrace(out);
		...
		try{
			++testNum;
			Class<?> dClass = Class.forName("lab01.Driver");
			Method m = dClass.getMethod("main", String[].class);
			Class<?> c2 = m.getReturnType();
...
//			e.printStackTrace(out);
		...
		try {
			...
			var testDate = LocalDate.of(2005, 3, 20);
			var today = LocalDate.now();
			var p = Period.between(testDate, today);
			String expected = p.getYears() + " years, " + p.getMonths() + " months, " + p.getDays() + " days"
					+ "Wilson"
					+ "Computer Science"
					+ "3.5"
					+ "3.4";
